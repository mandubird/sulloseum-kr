...
썰로세움은 **극단적인 싸움**이 아니라 **가치관 실험·관찰**을 목표로 합니다.  
AI 대사, UI 문구, 공유 문구 등을 수정할 때에는 다음을 염두에 두세요.

- **실험 느낌 유지**: “누가 이기나”보다 “이런 입장도 있구나”를 드러내는 쪽으로.
- **과장은 연기**: 페르소나는 극단적 입장을 **연기**하는 것이지, 서비스가 그 입장을 옹호하는 것이 아님.
- **안전한 관찰**: 생각의 차이를 안전하게 관찰하는 **장치**로 설계되었음을 개발 가이드와 프롬프트에서 일관되게 반영.

자세한 제작 동기는 메인 페이지 하단 **「왜 썰로세움을 만들었나요?」** 및 README의 제작 동기 섹션을 참고하세요.
